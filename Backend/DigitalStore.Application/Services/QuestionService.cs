    ...
    public class QuestionService : IQuestionService
    {
        ...
        private static QuestionDto MapToQuestionDto(Question q)
        {
            return new QuestionDto
            {
                ...
                QuestionFullImage = q.QuestionImages.FirstOrDefault(i => i.ImageTypeId == 1)?.ImageUrl,
                ...
                DetailedAnswer = q.DetailedAnswer != null ? new DetailedAnswerDto
                {
                    ...
                    FullAnswerImage = q.DetailedAnswer.AnswerImages.FirstOrDefault(i => i.ImageTypeId == 1)?.ImageUrl,
